...
Invoke-RestMethod [-Method <WebRequestMethod>] [-Uri] <Uri> [-WebSession <WebRequestSession>]
 ...
 [-TransferEncoding <String>] [-InFile <String>] [-OutFile <String>] [-PassThru] [-AllowEscapedDotsAndSlashes]
 [<CommonParameters>]
```
...
{{Fill AllowEscapedDotsAndSlashes Description}}
...
[https://go.microsoft.com/fwlink/?LinkID=217034](https://go.microsoft.com/fwlink/?LinkID=217034)
