...
InModuleScope -ModuleName OutSystems.SetupTools {
    Describe 'Test-OSServerHardwareReqs Tests' {
        ...
        Context 'OS10. When the machine does not have the required num of cores' {
            ...
            $result = Test-OSServerHardwareReqs -MajorVersion 10.0 -ErrorVariable err -ErrorAction SilentlyContinue
            ...
            It 'Should return the right result' {
                ...
                $result.Message | Should Be 'Hardware not supported for Outsystems 10.0. Number of CPU cores is less than 2'
            }
            It 'Should output an error' { $err[-1] | Should Be 'Hardware not supported for Outsystems 10.0. Number of CPU cores is less than 2' }
            It 'Should not throw' { { Test-OSServerHardwareReqs -MajorVersion 10.0 -ErrorAction SilentlyContinue } | Should Not throw }
        }
        ...
        Context 'OS10. When the machine does not have enought mem' {
            ...
            It 'Should return the right result' {
                $result.Result | Should Be $false
                $result.Message | Should Be 'Hardware not supported for Outsystems 10.0. Server has less than 4 GB'
            }
        ...
        Context 'OS10. When the machine is OK' {
            ...
            It 'Should return the right result' {
                ...
                $result.Message | Should Be 'Hardware was validated for Outsystems 10.0'
            }
        ...
        Context 'OS11. When the machine does not have the required num of cores' {
            ...
            $result = Test-OSServerHardwareReqs -MajorVersion 11.0 -ErrorVariable err -ErrorAction SilentlyContinue

            It 'Should call GetNumberOfCores' { Assert-MockCalled @assRunGetNumberOfCores }
            It 'Should not call GetInstalledRAM' { Assert-MockCalled @assNotRunGetInstalledRAM }
            It 'Should return the right result' {
                $result.Result | Should Be $false
                $result.Message | Should Be 'Hardware not supported for Outsystems 11.0. Number of CPU cores is less than 2'
            }
            It 'Should output an error' { $err[-1] | Should Be 'Hardware not supported for Outsystems 11.0. Number of CPU cores is less than 2' }
            It 'Should not throw' { { Test-OSServerHardwareReqs -MajorVersion 11.0 -ErrorAction SilentlyContinue } | Should Not throw }
        }
        ...
        Context 'OS11. When the machine does not have enought mem' {
            ...
            It 'Should return the right result' {
                $result.Result | Should Be $false
                $result.Message | Should Be 'Hardware not supported for Outsystems 11.0. Server has less than 4 GB'
            }
        ...
        Context 'OS11. When the machine is OK' {
            ...
            It 'Should return the right result' {
                $result.Result | Should Be $true
                $result.Message | Should Be 'Hardware was validated for Outsystems 11.0'
            }
            It 'Should not output an error' { $err.Count | Should Be 0 }
            It 'Should not throw' { { Test-OSServerHardwareReqs -MajorVersion 11.0 -ErrorAction SilentlyContinue } | Should Not throw }
        }
