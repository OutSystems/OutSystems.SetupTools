...
InModuleScope -ModuleName OutSystems.SetupTools {
    Describe 'Get-OSServiceStudioInfo Tests' {
        ...
        Mock GetServiceStudioInstallDir { return 'C:\Program Files\OutSystems\Development Environment 10\Service Studio' }

        $assGetServiceStudioVersion = @{ 'CommandName' = 'GetServiceStudioVersion'; 'Times' = 1; 'Exactly' = $true; 'Scope' = 'Context'; 'ParameterFilter' = { $MajorVersion -eq '10' }}
        $assGetServiceStudioInstallDir = @{ 'CommandName' = 'GetServiceStudioInstallDir'; 'Times' = 1; 'Exactly' = $true; 'Scope' = 'Context'; 'ParameterFilter' = { $MajorVersion -eq '10' }}
        ...
        Context 'When service studio is not installed' {
            ...
            Get-OSServiceStudioInfo -MajorVersion '10' -ErrorAction SilentlyContinue -ErrorVariable err
        ...
        Context 'When service studio is installed' {
            ...
            $output = Get-OSServiceStudioInfo -MajorVersion '10' -ErrorAction SilentlyContinue -ErrorVariable err
