...
InModuleScope -ModuleName OutSystems.SetupTools {
    Describe 'Publish-OSPTool-Solution Tests' {
        ...
        Context 'When the platform server is not installed' {
            ...
            $result = Publish-OSPTool-Solution -ErrorVariable err -ErrorAction SilentlyContinue
            ...
            It 'Should not throw' { { Publish-OSPTool-Solution -ErrorAction SilentlyContinue } | Should Not throw }
        }
        ...
        Context 'When system components and platform have the same version but the force switch is specified' {
            ...
            $result = Publish-OSPTool-Solution -Force -ErrorVariable err -ErrorAction SilentlyContinue
        ...
        Context 'When ServiceCenterUser is specified' {
            ...
            $result = Publish-OSPTool-Solution -ServiceCenterUser 'Whatever' -ErrorVariable err -ErrorAction SilentlyContinue
        ...
        Context 'When credentials are specified' {
            ...
            $result = Publish-OSPTool-Solution -Credential $cred -ErrorVariable err -ErrorAction SilentlyContinue
