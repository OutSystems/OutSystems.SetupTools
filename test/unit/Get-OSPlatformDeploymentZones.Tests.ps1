...
InModuleScope -ModuleName OutSystems.SetupTools {
    Describe 'Get-OSPlatformDeploymentZones Tests' {
        ...
        Context 'When user is not admin' {
            ...
            Get-OSPlatformDeploymentZones -ErrorVariable err -ErrorAction SilentlyContinue
            ...
            It 'Should not throw' { { Get-OSPlatformDeploymentZones -ErrorAction SilentlyContinue } | Should Not throw }
        }
        ...
        Context 'When platform is not installed' {
            ...
            Get-OSPlatformDeploymentZones -ErrorAction SilentlyContinue -ErrorVariable err
        ...
        Context 'When the everything is successfull' {
            ...
            $result = Get-OSPlatformDeploymentZones -ErrorAction SilentlyContinue -ErrorVariable err
